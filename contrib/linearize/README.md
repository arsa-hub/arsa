# Linearize
Construct a linear, no-fork, best version of the Arsa blockchain. The scripts
...
JSON-RPC server. Running `arsad` or `arsa-qt -server` will be sufficient.
...
* `input`: arsad blocks/ directory containing blkNNNNN.dat
