Contributing to Arsa Core
============================

The Arsa Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/arsa-hub/arsa/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Arsa Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Arsa
Network Protocol consensus changes.

Whether a pull request is merged into Arsa Core rests with the project merge
...
Patches that change Arsa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arsa consensus, it must have been
...
The review process is normally fairly responsive on the Arsa Core repository, however
...
The project leader is the release manager for each Arsa Core release.
