...
"""Verify that starting arsad with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arsad with -h for help text")
        ...
        self.log.info("Start arsad with -version for version information")
