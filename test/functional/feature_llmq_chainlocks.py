...
from test_framework.test_framework import ArsaTestFramework
...
class LLMQChainLocksTest(ArsaTestFramework):
    def set_test_params(self):
        self.set_arsa_test_params(6, 5, fast_dip3_enforcement=True)
