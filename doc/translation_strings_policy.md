...
This document provides guidelines for internationalization of the Arsa Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `arsa_en.ts` remains unchanged.
