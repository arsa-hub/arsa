...
space *do not upload these to the arsa.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the arsa.org server

- Update arsa.org

- Announce the release:

  - Release on Arsa forum: https://www.arsa.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Arsa, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~arsa.org/+archive/ubuntu/arsa)
