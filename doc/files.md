...
* arsa.conf: contains configuration settings for arsad or arsa-qt
* arsad.pid: stores the process id of arsad while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by arsad or arsa-qt
