...
/** Utility functions used by the Arsa Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "arsa:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load arsa specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a arsa specific theme is activated (light/dark).*/
