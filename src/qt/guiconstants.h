...
/* ArsaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* ArsaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_APP_NAME_REGTEST "Arsa-Qt-regtest"
