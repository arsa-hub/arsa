...
{
    const char* pszTimestamp = "On 14/Feb/2023 Arsa is name of the Blockchain that will rule";
    const CScript genesisOutputScript = CScript() << ParseHex("0475f2eef6ab830f79319feb5ad7504fd8fec1bf46e83941db8d4ebc94fc7112d9fea4e4fc54d4d62578992b375f3568f1b14609f22a9d7527ddaa0e98326e4dd2") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Arsa: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Arsa: 2 minutes
        ...
        consensus.nMinimumChainWork = uint256S("00000000000000000000000000000000000000000000000000000294be965852"); // block 7160 chainwork

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x4d92f5918b0c42e980a6ac1a563e4fe585beeb13de15f3872db1d967628f73bb"); // block hash for 7160
        ...
        //FindMainNetGenesisBlock(1682631923, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1682631923, 3900, 0x20001fff, 4, 5000 * COIN);
        ...
        // Arsa private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Arsa BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Arsa BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Arsa BIP44 coin type is '5'
...
//        }
        ...
        vSporkAddresses = {"AMHRuHPsg97ZrMwYVE2d4mwTGHfnhPkr78"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = {
          {  {2720, uint256S("0xa5366926d2fc4a9a216b2bb13e4d968363fdaf286f9933f82586ca4717c2cd0e")},
             {3600, uint256S("0xd7533ddcc6e9cd1c4643cf64fec3839f8d537b50c22f2718416e69d5c3a6ad79")},
             {7000, uint256S("0x0acc6235c655464d25203f9aa06613bd76972857a6fa2018986428d311827543")}             
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Arsa: 1 day
        consensus.nPowTargetSpacing = 60; // Arsa: 1 minutes
        ...
        genesis = CreateGenesisBlock(1678810092, 699, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xaba83826b5ba5f6374d01d50232886c9eaba42f0807fa45e932bfb2579ccf3e4"));
        assert(genesis.hashMerkleRoot == uint256S("0x4067f36c150df7c3432d6e4be2fa168f90dab56cfbed123267a02a1f1667502d"));
        ...
        vSeeds.emplace_back("tnet.arsagility.com");

        // Testnet Arsa addresses start with 
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23);
        // Testnet Arsa script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Arsa BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Arsa BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Arsa BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
        ...
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 5}  };// 5% founder/dev fee forever
        consensus.nFounderPayment = FounderPayment(rewardStructures, 200, "ATiu15rN6PJFKqjBuLuNVHJAWKjNa5oibm");
        ...
        vSporkAddresses = {"aTiu15rN6PJFKqjBuLuNVHJAWKjNa5oibm"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Arsa: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Arsa: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000a77b43200c6be963b95d0785db0d8cafca06cf8b38a6f0741d9d9167f8db8");
	...
	//FindMainNetGenesisBlock(1417713337,  0x20001fff, "dev");
        genesis = CreateGenesisBlock(1417713337, 1263, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5da40fd850ea978809a6d84f3ca2145bfa8293e796a971399f0363b23f58df7a"));
        assert(genesis.hashMerkleRoot == uint256S("0x4067f36c150df7c3432d6e4be2fa168f90dab56cfbed123267a02a1f1667502d"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("arsaevo.org",  "devnet-seed.arsaevo.org"));

        // Testnet Arsa addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        vSporkAddresses = {"FyPj3YXjdcB43Y3YXjNyj3YXjNb"};
        nMinSporkKeys = 1;
        ...
        // Regtest Arsa addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Arsa script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Arsa BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Arsa BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Arsa BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
