...
//! Interface for the src/evo part of a arsa node (arsad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a arsa node (arsad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a arsa node (arsad process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a arsa node (arsad process).
class Node
{
public:
    virtual ~Node() {}
