...
rm -rf test_bitcoin.coverage/ arsa-gtest.coverage/ total.coverage/
...
clean_exe src/arsa-cli
clean_exe src/arsad
clean_exe src/arsa-gtest
clean_exe src/arsa-tx
clean_exe src/test/test_arsa
clean_exe src/test/test_arsa_fuzzy
...
clean_dep . src/config/arsa-config.h.in
